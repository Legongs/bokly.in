...
export const metadata: Metadata = {
  metadataBase: new URL('https://maubooking.in'),
  title: {
    default: "maubooking.in | Aplikasi Reservasi Online UMKM Indonesia",
    template: "%s | maubooking.in",
  },
  ...
  authors: [{ name: "maubooking.in" }],
  creator: "maubooking.in",
  openGraph: {
    type: "website",
    locale: "id_ID",
    url: "https://maubooking.in",
    title: "maubooking.in | Aplikasi Reservasi Online UMKM",
  ...
  twitter: {
    ...
    title: "maubooking.in | Bikin Web Booking Otomatis",
