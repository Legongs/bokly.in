  ...
  return (
    <main className="min-h-screen bg-white flex">
      ...
      <div className="hidden lg:flex flex-1 bg-stone-50 items-center justify-center p-12 relative overflow-hidden">
        {/* Dekorasi Organik */}
        <div className="absolute top-0 right-0 w-[40rem] h-[40rem] bg-indigo-50/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-[30rem] h-[30rem] bg-amber-50/50 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4" />
        ...
        <div className="relative z-10 max-w-lg w-full flex flex-col gap-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-indigo-600 to-indigo-500 text-white rounded-[2rem] p-6 shadow-lg shadow-indigo-600/20 relative overflow-hidden group">
              ...
              <CheckCircle2 className="w-8 h-8 mb-4 text-indigo-100" />
              <p className="font-bold text-lg leading-tight mb-1">Terima DP Instan</p>
              <p className="text-indigo-50 text-sm font-medium leading-snug">Approve booking masuk cuma dengan satu klik aja.</p>
            </div>
