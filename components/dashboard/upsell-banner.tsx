...
export function UpsellBanner({ feature, requiredPlan, description }: UpsellBannerProps) {
  return (
    <div className="rounded-2xl border border-indigo-200 bg-indigo-50/70 p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center gap-5">
      {/* Ikon */}
      <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-indigo-100 border border-indigo-200 flex items-center justify-center">
      ...
      <div className="flex-shrink-0 w-full sm:w-auto">
        <Link href="/dashboard/billing">
          <Button
            ...
            className="w-full sm:w-auto bg-indigo-600 text-white font-bold hover:bg-indigo-700 shadow-md shadow-indigo-600/20 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200 gap-2"
          >
            Upgrade Sekarang
