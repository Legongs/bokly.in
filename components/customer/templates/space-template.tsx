      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-12 pb-24">
        <header className="flex flex-col md:flex-row items-center md:items-start justify-between gap-8 mb-12 md:mb-16 text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div>
              <p className={`text-sm font-bold tracking-widest uppercase text-stone-500 mb-2`}>bukly.in/{tenant.slug}</p>
        ...
        <footer className="mt-24 text-center">
          ...
          <a href="https://bukly.in" target="_blank" rel="noopener noreferrer" className="inline-block hover:opacity-80 transition-all duration-200 bg-white px-5 py-2.5 rounded-xl shadow-sm border border-stone-200">
